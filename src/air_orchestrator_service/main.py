...
**A missing downstream is a deployment shape, not a failure.** air-orchestrator-service is
...
from air_orchestrator_service.api.deps import STATE_ATTR, AppState
from air_orchestrator_service.api.errors import install_error_handlers
from air_orchestrator_service.api.middleware import install_middleware
from air_orchestrator_service.api.v1.router import build_v1_router
from air_orchestrator_service.api.v1.system import build_metrics_router
from air_orchestrator_service.clients.infra import InfraClient
from air_orchestrator_service.clients.llm import LlmClient
from air_orchestrator_service.config import Settings, get_settings
from air_orchestrator_service.memory.session import build_session_store
from air_orchestrator_service.observability.logging import configure_logging, get_logger
from air_orchestrator_service.security.api_keys import ApiKeyStore

__all__ = ["OrjsonResponse", "app", "create_app"]

_log = get_logger(__name__)

_TITLE: Final[str] = "AIR Orchestrator Service"
...
#: Module-level app for ``uvicorn air_orchestrator_service.main:app``.
#:
