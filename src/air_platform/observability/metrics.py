...
_TURN_COST = Counter(
    "air_platform_turn_cost_usd_total",
...
_CACHE_LOOKUPS = Counter(
    "air_platform_cache_lookups_total",
...
_GUARDRAIL_BLOCKS = Counter(
    "air_platform_guardrail_blocks_total",
...
_DOWNSTREAM_CALLS = Counter(
    "air_platform_downstream_calls_total",
