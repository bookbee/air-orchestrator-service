...
dependency whose absence is fatal is air-infra, which lands on 503
...
from air_platform.constants import HEADER_REQUEST_ID
from air_platform.observability.logging import get_logger
from air_platform.schemas.errors import FieldError, ProblemDetail
...
class DependencyUnavailableError(AppError):
    """air-infra is unreachable, so no turn can be synthesised.

    The only 5xx this service raises for a dependency, and reserved for air-infra
