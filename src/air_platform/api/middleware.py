...
from air_platform.api.errors import MalformedRequestError, problem_response
...
from air_platform.observability.logging import (
...
class _BodyTooLargeError(Exception):
    ...
    Deliberately not an :class:`~air_platform.api.errors.AppError`: it must travel
